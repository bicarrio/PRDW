...
Los nombres de las variables son para "engañar" al Crayfish y poder plotear los resultados.
...
t_id_plot = np.arange(0,241,timestep_plot)
...
outfile = netCDF4.Dataset('velocities_test.sww',mode='w',format='NETCDF4')
...
u_out = outfile.createVariable('xmomentum', np.float32, ('number_of_timesteps','number_of_points'))
u_out[:] = u[:]
u_out.units='m/s'

v_out = outfile.createVariable('ymomentum', np.float32, ('number_of_timesteps','number_of_points'))
v_out[:] = v[:]
v_out.units='m/s'
